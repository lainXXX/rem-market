...
INSERT INTO `raffle_activity_account` VALUES (4, 'rem', 100301, 64, 56, 64, 56, 64, 56, '2024-12-08 01:56:49', '2025-01-18 19:12:38');
...
INSERT INTO `raffle_activity_account_month_count` VALUES (2, 'rem', 100301, '2025-01', 60, 60, '2025-01-13 15:44:01', '2025-01-18 19:12:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖活动单' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `raffle_activity_sku` VALUES (1, 9011, 100301, 11101, 20, 3, 1.68, '2024-03-16 11:41:09', '2025-01-18 23:17:54');
...
CREATE TABLE `task`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 283 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务表，发送MQ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_behavior_rebate_order`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户行为返利流水订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `user_credit_account` VALUES (2, 'rem', 21.60, 21.60, 'open', '2025-01-17 18:04:05', '2025-01-18 19:12:38');
...
CREATE TABLE `user_credit_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uq_out_business_no`(`out_business_no` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分订单表' ROW_FORMAT = Dynamic;
