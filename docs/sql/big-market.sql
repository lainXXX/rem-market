...
INSERT INTO `raffle_activity_account` VALUES (4, 'rem', 100301, 2, 1, 2, 1, 2, 1, '2024-12-08 01:56:49', '2024-12-08 15:11:14');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖活动账户表-日次数' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `raffle_activity_account_month_count` VALUES (1, 'rem', 100301, '2024-12', 2, 1, '2024-12-08 15:11:29', '2024-12-08 15:11:29');
...
CREATE TABLE `rule_tree_node`  (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `tree_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '规则树ID',
  `treee_node_key` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '规则Key',
...
INSERT INTO `rule_tree_node_line` VALUES (3, 'tree_lock_1', 'rule_stock', 'rule_luck_award', 'EQUAL', 'PASS', '0000-00-00 00:00:00', '2024-12-08 01:35:27');
INSERT INTO `rule_tree_node_line` VALUES (4, 'tree_luck_award', 'rule_stock', 'rule_luck_award', 'EQUAL', 'PASS', '2024-02-15 07:37:31', '2024-12-08 01:35:29');
...
INSERT INTO `rule_tree_node_line` VALUES (7, 'tree_lock_2', 'rule_stock', 'rule_luck_award', 'EQUAL', 'PASS', '0000-00-00 00:00:00', '2024-12-08 01:35:32');
...
-- ----------------------------
INSERT INTO `user_raffle_order` VALUES (1, 'rem', 100301, '测试活动', 100006, '406284951110', '2024-12-08 15:11:29', 'create', '2024-12-08 15:11:29', '2024-12-08 15:11:29');
