...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖活动账户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `raffle_activity_account` VALUES (4, 'rem', 100301, 62, 54, 62, 54, 62, 54, '2024-12-08 01:56:49', '2025-01-15 16:54:29');
INSERT INTO `raffle_activity_account` VALUES (5, 'user001', 100301, 22, 15, 22, 15, 22, 15, '2025-01-16 20:11:59', '2025-01-16 22:16:11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖活动账户表-日次数' ROW_FORMAT = Dynamic;
...
INSERT INTO `raffle_activity_account_month_count` VALUES (2, 'rem', 100301, '2025-01', 58, 58, '2025-01-13 15:44:01', '2025-01-15 16:54:29');
INSERT INTO `raffle_activity_account_month_count` VALUES (3, 'user001', 100301, '2025-01', 22, 15, '2025-01-16 20:54:37', '2025-01-16 22:16:11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '抽奖活动单' ROW_FORMAT = Dynamic;
...
INSERT INTO `raffle_activity_order` VALUES (19, 'rem', 9011, 100301, '测试活动', 100006, '84677981222', '2025-01-13 16:16:07', 1, 1, 1, 'completed', 'rem_sku_20250110', '2025-01-13 16:16:07', '2025-01-13 16:16:07');
INSERT INTO `raffle_activity_order` VALUES (20, 'rem', 9011, 100301, '测试活动', 100006, '63405337440', '2025-01-13 16:16:07', 1, 1, 1, 'completed', 'rem_sku_20250111', '2025-01-13 16:16:07', '2025-01-13 16:16:07');
INSERT INTO `raffle_activity_order` VALUES (21, 'rem', 9011, 100301, '测试活动', 100006, '99078481730', '2025-01-13 16:24:36', 1, 1, 1, 'completed', 'rem_sku_20250112', '2025-01-13 16:24:36', '2025-01-13 16:24:36');
INSERT INTO `raffle_activity_order` VALUES (22, 'rem', 9011, 100301, '测试活动', 100006, '41554197025', '2025-01-13 16:24:37', 1, 1, 1, 'completed', 'rem_sku_20250103', '2025-01-13 16:24:37', '2025-01-13 16:24:37');
INSERT INTO `raffle_activity_order` VALUES (23, 'rem', 9011, 100301, '测试活动', 100006, '57059196567', '2025-01-13 16:33:48', 1, 1, 1, 'completed', 'rem_sku_20250104', '2025-01-13 16:33:48', '2025-01-13 16:33:48');
INSERT INTO `raffle_activity_order` VALUES (24, 'rem', 9011, 100301, '测试活动', 100006, '25389151485', '2025-01-13 16:33:49', 1, 1, 1, 'completed', 'rem_sku_20250106', '2025-01-13 16:33:49', '2025-01-13 16:33:49');
INSERT INTO `raffle_activity_order` VALUES (25, 'rem', 9011, 100301, '测试活动', 100006, '43666714386', '2025-01-13 16:34:21', 1, 1, 1, 'completed', 'rem_sku_20250107', '2025-01-13 16:34:21', '2025-01-13 16:34:21');
INSERT INTO `raffle_activity_order` VALUES (26, 'rem', 9011, 100301, '测试活动', 100006, '33026378514', '2025-01-13 16:34:23', 1, 1, 1, 'completed', 'rem_sku_20250108', '2025-01-13 16:34:23', '2025-01-13 16:34:23');
INSERT INTO `raffle_activity_order` VALUES (27, 'rem', 9011, 100301, '测试活动', 100006, '26330247441', '2025-01-13 16:39:33', 1, 1, 1, 'completed', 'rem_sku_20250109', '2025-01-13 16:39:33', '2025-01-13 16:39:33');
INSERT INTO `raffle_activity_order` VALUES (34, 'rem', 9011, 100301, '测试活动', 100006, '57672670618', '2025-01-13 17:40:12', 1, 1, 1, 'completed', 'rem_sku_20250113', '2025-01-13 17:40:12', '2025-01-13 17:40:12');
INSERT INTO `raffle_activity_order` VALUES (35, 'rem', 9011, 100301, '测试活动', 100006, '71425737058', '2025-01-15 16:54:44', 1, 1, 1, 'completed', 'rem_sku_20250115', '2025-01-15 16:54:44', '2025-01-15 16:54:44');
...
-- ----------------------------
INSERT INTO `raffle_activity_sku` VALUES (1, 9011, 100301, 11101, 20, 13, '2024-03-16 11:41:09', '2025-01-16 20:12:30');
...
CREATE TABLE `task`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 277 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务表，发送MQ' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 240 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户中奖记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_behavior_rebate_order`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 69 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户行为返利流水订单表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分账户' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_credit_account
-- ----------------------------
INSERT INTO `user_credit_account` VALUES (1, 'user001', 1.37, 1.37, 'open', '2025-01-16 21:58:39', '2025-01-16 22:16:12');
INSERT INTO `user_credit_account` VALUES (2, 'rem', 0.00, 0.00, 'open', '2025-01-17 18:04:05', '2025-01-17 18:06:33');
...
CREATE TABLE `user_credit_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uq_out_business_no`(`out_business_no` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户积分订单表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户抽奖订单表' ROW_FORMAT = Dynamic;
