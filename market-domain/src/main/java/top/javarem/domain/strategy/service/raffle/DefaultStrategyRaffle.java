...
public class DefaultStrategyRaffle extends AbstractStrategyRaffle {
     ...
     */
    @Override
    protected RuleActionEntity<RuleActionEntity.RaffleBeforeEntity> doRaffleBeforeLogic(RaffleFactorEntity factor, String[] ruleModels) {
...
//        后续的过滤
        List<String> models = Arrays.stream(ruleModels)
                .filter(model -> !model.equals(DefaultLogicFactory.LogicModel.RULE_BLACKLIST.getCode()))
